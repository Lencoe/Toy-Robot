...
public class ForwardRequestMessage extends RequestMessage {
    public ForwardRequestMessage(){}

    public ForwardRequestMessage(String robot, List<Object> arguments)
    {
        super(robot, "forward", arguments);
    }
